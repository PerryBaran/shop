...
const featured = [
    {name: 'Dying Light 2: Stay Human', src: dyingLight, featured: dylingLightCover, price: 54.99},
    {name: 'Elden Ring', src: eldenRing, featured: eldenRingCover, price: 49.99},
    {name: 'Farming Simulator 22', src: farmingSimulator22, featured: farmingSimulator22Cover,  price: 34.99},
    {name: 'Ghostwire: Tokyo', src: ghostwireTokyo, featured: ghostwireTokyoCover,  price: 49.99},
    {name: 'God Of War', src: godOfWar, featured: godOfWarCover,  price: 39.99},
    {name: 'Dead Cells', src: deadCells, price: 21.99},
    {name: 'Metro Exodus', src: metroExodus, price: 24.99},
    {name: 'The Witcher 3: Wild Hunt', src: witcher3, price: 34.99},
    {name: 'Fallout: New Vegas', src: falloutNewVegas, price: 7.99},
    {name: 'Halo: The Master Chief Collection', src: haloMCC, price: 29.99},
    {name: 'Red Dead Redemption 2', src: redDead2, price: 54.99},
    {name: 'Left 4 Dead 2', src: left4Dead2, price: 7.19},
    {name: 'Among Us', src: amongUs, price: 3.99},
    {name: 'The Binding of Isaac: Rebirth', src: bindingOfIsaac, price: 10.99},
    {name: 'Hollow Knight', src: hollowKnight, price: 10.99},
    {name: 'Battlefield 2042', src: battlefield2042, price: 49.99},
    {name: 'Hades', src: hades, price: 19.49},
    {name: 'Wreckfest', src: wreckfest, price: 26.74},
    {name: 'Sekiro: Shadows Die Twice', src: sekiro, price: 49.90},
    {name: 'Borderlands 3', src: borderlands3, price: 49.99},
]
